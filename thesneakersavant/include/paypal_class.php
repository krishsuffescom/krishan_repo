 ...
 */
	public function validate_ipn() {
		...
		if (isset($this->paypal_mail) && strtolower ( $_SESSION['return_p']['receiver_email'] ) != strtolower(trim( $this->paypal_mail ))) {
			$this->ipn_status = "Receiver Email Not Match";
			$this->log_ipn_results ( false );
			return false;
		}
		
		if (isset($this->txn_id)&& in_array( $_SESSION['return_p']['txn_id'],$this->txn_id)) {
		...
		$paypal_url = ( $_SESSION['return_p']['test_ipn'] == 1) ? SSL_SAND_URL : SSL_P_URL;
