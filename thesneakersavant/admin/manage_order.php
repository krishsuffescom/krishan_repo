...
//$page_child = 'add_edit_brand.php';				// table name for query
...
$select = "$base_tabl.* ";
$from = "  $base_tabl where 1=1 and status='1' ";
...
if($_GET['search'] == '' || $_GET['search'] == 'search'){
	...
	$sql1 = "SELECT $select from $from AND $base_tabl.desription like '%$search_txt_db%'"; 
}
...
$sqlq = $sql1;
$sql2 = $sql1." ORDER BY time DESC LIMIT $stcom , $perpage";
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string_pg; ?>" method="post" name="<?php echo $item; ?>">
          ...
          <table width="100%" cellspacing="0" cellpadding="0"  class="maintbl" >
            <tr class="fstrow"  >
              ...
              <td align="left" width="30%">Desription</td>
           <!--   <td align="center" width="10%"> Position </td>-->
            ...
            <tr class="scndrow <?php echo $z%2 ? '' : 'alternate';?>">
              ...
              <td align="left"><div class="n_1"><?php echo $fetch['desription']; ?></div></td>
              
            <!--  <td align="center"><a href="sort_gen.php?type=desription&tab=<?php echo $tabl; ?>&height=500&width=600&rel=<?php echo $fetch['id']; ?>" class="thickbox"><img src="images/sort-neither.png" title="Sort" width="13" height="16" /></a></td>-->
             ...
             <!-- <td align="center"><a title="View" href="manage_aspiration_text.php?qee=<?php echo $fetch['id']; ?>" class="addq"><big><b>+</b></big>Aspirations Text</a></td>-->
              <td align="center">
              	 <a style="margin:0px 10px;" href="view_order.php?do=view&id=<?php echo $fetch['uniq_key'].$q_string_pg; ?>" title="View"> <img src="images/view.png" /> </a>
