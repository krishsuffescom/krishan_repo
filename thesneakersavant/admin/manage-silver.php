...
$item = 'Silver';				// table name for query
$page_child = 'add_edit_silver.php';				// table name for query
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string_pg; ?>" method="post" name="<?php echo $item; ?>">
          ...
          <table width="100%" cellspacing="0" cellpadding="0"  class="maintbl" >
            ...
            <tr class="scndrow <?php echo $z%2 ? '' : 'alternate';?>">
              ...
              <td align="left"><div class="n_1"><?php echo $fetch['value']; ?></div></td>
              
              <td align="center"><a href="sort_gen.php?type=value&tab=<?php echo $tabl; ?>&height=500&width=600&rel=<?php echo $fetch['id']; ?>" class="thickbox"><img src="images/sort-neither.png" title="Sort" width="13" height="16" /></a></td>
